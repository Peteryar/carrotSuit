...
class ForgotPassword extends React.Component {
    ...
    render() {
        return (
            <View>
                <ImageBackground source={require('../../../assets/Task.png')}
                    ...
                    <View style={styles.paddlockCon}>
                        <View style={{height:'20%',justifyContent:"flex-end"}}>
                            <MaterialIcons
                                ...
                                size={25} style={{ paddingLeft:10, color: '#fff' }} />
                        </View>
                ...
                <View style={styles.titleCon}>
                    ...
                    <Text
                        style={[styles.actionInfo, { fontFamily: "ptsans-bold" }]}>
                ...
                <View style={{ alignItems: "center", justifyContent: "center", height: 30 / 100 * height }}>
                    ...
                    <Text
                        onPress={() => this.props.navigation.navigate('Login')}
                        style={{ marginTop: 2.81 / 100 * height, fontFamily: 'ptsans-bold' }}>
                        Login
                    </Text>
                </View>
            </View>
